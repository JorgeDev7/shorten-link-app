...
import ListadoLinks from './components/ListadoLinks';
...
function App() {
  ...
  return (
    ...
    <>
      ...
      <header className="header container-xl mt-5 px-4">
        <nav
        ...
        >
          ...
          <div
            className='collapse navbar-collapse d-md-flex justify-content-md-between align-items-md-center mt-4 mt-md-0'
            id='navResponsive'
          >
            <ul className='header__list navbar-nav pt-5 pt-md-0 ps-md-5'>
              <li className='header__item nav-item'>
                <a className='header__link nav-link' href="#">Features</a>
              </li>
              <li className='header__item nav-item'>
                <a className='header__link nav-link' href="">Pricing</a>
              </li>
              <li className='header__item nav-item'>
                <a className='header__link nav-link' href="">Resources</a>
              </li>
            </ul>

            <ul className='header__list header__list--second navbar-nav pb-5 pb-md-0'>
              <li className='header__item nav-item pb-3 pb-md-0 pe-md-5'>
                <a className='header__link nav-link' href="">Login</a>
              </li>
              <li className='header__item header__item--sp nav-item p-2 py-md-1 px-md-5'>
                <a className='header__link header__link--sp nav-link text-center' href="">Sign Up</a>
              </li>
            </ul>
          </div>
        </nav>
      ...
      <section className='hero pt-5 container-xl'>
        ...
        <div className="hero__content">
          ...
          <p className='hero__text'>Build your brand’s recognition and get detailed insights
      ...
      <main className='main'>
        <div className="container-xl">
          <div className="shorten-section d-flex justify-content-start">
            <img
              className='shorten-section__bg-mobile d-md-none'
              src={bgShortenMobile}
              alt="bg-shorten-mobile"
            />
            <img
              className='shorten-section__bg-desktop d-none d-md-block'
      ...
      <section className="statistics">
        ...
        <div className="container-xl">
          ...
          <p className="statistics__text">Track how your links are performing across the web with our
            advanced statistics dashboard.</p>

          <div className='statistics__grid'>
            <div className='statistics__card brand-recognition'>
              <div className='statistics__img rounded-circle'>
                <img
              ...
              <div className='statistics__content'>
                <h3 className='statistics__title'>Brand Recognition</h3>
                <p className='statistics__paragraph'>Boost your brand recognition with each click. Generic links don’t
                  mean a thing. Branded links help instil confidence in your content.</p>
              </div>
            </div>
            <div className='d-flex d-md-block justify-content-center'>
              <div className="statistics__divider statistics__divider--desk-1"></div>
            </div>
            <div className='statistics__card detailed-records'>
              <div className='statistics__img rounded-circle'>
                <img
                  src={detailedRecords}
              ...
              <div className='statistics__content'>
                <h3 className='statistics__title'>Detailed Records</h3>
                <p className='statistics__paragraph'>Gain insights into who is clicking your links. Knowing when and where
                  people engage with your content helps inform better decisions.</p>
              </div>
            </div>
            <div className='d-flex d-md-block justify-content-center'>
              <div className="statistics__divider statistics__divider--desk-2"></div>
            </div>
            <div className='statistics__card fully-customizable'>
              <div className='statistics__img rounded-circle'>
                <img
              ...
              <div className='statistics__content'>
                <h3 className='statistics__title'>Fully Customizable</h3>
                <p className='statistics__paragraph'>Improve brand awareness and content discoverability through customizable
      ...
      <section className='boost'>
        <div className="container-xl">
          <div className='boost__content'>
            <h2 className='boost__heading'>Boost your links today</h2>
            <button className='boost__btn' type='button'>Get Started</button>
          </div>
        </div>
      </section>
      ...
      <footer className="footer">
        <div className="container-xl">
          <div className='footer__content'>
            ...
            <ul className='footer__list list-group list-unstyled'>
            ...
            <div className='footer__social d-flex align-items-center gap-5 pt-3'>
              {/* FACEBOOK */}
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
